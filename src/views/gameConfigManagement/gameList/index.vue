  ...
  <div class="app-container">
    ...
    <div class="head-container">
        ...
        >
          ...
          <el-form-item label="游戏类型">
            <el-radio-group v-model="scopeData.gtid">
              <el-radio :label="4">页游</el-radio>
              <el-radio :label="5">手游</el-radio>
              <el-radio :label="6">单机</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item v-if="isShow" label="游戏所属平台">
            <el-select
          ...
          <el-form-item v-if="isShow" label="是否屏蔽">
          ...
          <el-form-item v-if="isShow" label="游戏类型(如棋牌、冒险等)">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="游戏收益提成">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="IOS下载地址">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="GooGle下载地址">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="游戏官网">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="fb粉丝页地址">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="手游二维码链接">
            <el-input v-model="scopeData.moneyHKD" style="width: 80%" />
          </el-form-item>
          <el-form-item v-if="isShow" label="平台手游星级图标">
            <el-select
              v-model="serviceValue"
          ...
          <el-form-item v-if="isShow" label="平台图片">
            <el-upload
      ...
      >
        ...
        <el-table-column
          v-permission="['admin', 'gameRoom:edit']"
          label="操作"
          width="120px"
          align="center"
        >
...
<script>
import { gameList, add, edit, getAll } from '@/api/gameRoom'
